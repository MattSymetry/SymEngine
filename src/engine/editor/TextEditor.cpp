...
bool TextEditor::IsLineReadOnly(int line) const {
	return mReadOnlyLines.find(line) != mReadOnlyLines.end();
}
...
void TextEditor::HandleKeyboardInputs()
{
	...
	if (IsLineReadOnly(cursorPos.mLine)) {
		return;
	}
...
void TextEditor::Render(const char* aTitle, const ImVec2& aSize, bool aBorder)
{
	...
	mIsFocused = ImGui::IsWindowFocused(ImGuiFocusedFlags_ChildWindows) || ImGui::IsItemActive();
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::GLSL()
{
	...
	if (!inited)
	{
		static const char* const keywords[] = {
			...
			"_Noreturn", "_Static_assert", "_Thread_local", "vec2", "vec3", "vec4"
		};
		for (auto& k : keywords)
			langDef.mKeywords.insert(k);

		static const char* const identifiers[] = {
			"length", "sin", "cos", "tan", "abort", "abs", "acos", "asin", "atan", "atexit", "atof", "atoi", "atol", "ceil", "clock", "cosh", "ctime", "div", "exit", "fabs", "floor", "fmod", "getchar", "getenv", "isalnum", "isalpha", "isdigit", "isgraph",
