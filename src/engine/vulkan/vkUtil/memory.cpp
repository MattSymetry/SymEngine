...
void vkUtil::copyBuffer(vk::Buffer& srcBuffer, vk::Buffer& dstBuffer, vk::DeviceSize size, vk::Queue queue, vk::CommandBuffer commandBuffer, vk::Fence fence) {
	...
	vkUtil::endJob(commandBuffer, queue, fence);
}